       ...
       $('#listado_codigos').DataTable({
               ...
               // processing: true, 
                serverSide: true,                              
        	     ...
        	     ajax:{
        		            url : BASE_URL + "gestores/codigos_prestacionales/listar/listar_codigos_ajax", // json datasource
        	                    ...
        	                    { data: null, orderable: false ,render: function ( data, type, row ) {
        				                 ...
        				                 // Opciones de la tabla                                                
                                            return "<div class='action-buttons' id='" + data.id_registro  + "' + > "+                                                    
                                                     "<a class='btn btn-outline-info' href='"+  BASE_URL+ "gestores/codigos_prestacionales/editar/form_editar/" + data.id_registro +"'"+
            ...
            function(isConfirm){
              if (isConfirm) {
                //proceder a eliminar:
                 $.ajax({
                    type: "POST",
                    url: BASE_URL + "gestores/codigos_prestacionales/listar/eliminar_registro_fisico/"+id ,
                    data: dataString,
                    cache: false,
                    success: function(e)
                    {
