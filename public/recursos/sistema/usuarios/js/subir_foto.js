$(document).ready(function () {
    ...
    if(typeof FOTO_EMPLEADO === 'undefined' ){
        FOTO_EMPLEADO = 'avatar_defecto.png';
    }
  
    // the file input
   var $el4 = $('#foto_usuario'), initPlugin = function() {
        $el4.fileinput({
            ...
            removeTitle: 'Cancel or reset changes',
             defaultPreviewContent: '<img id="preview_foto_usuario" src="'  + BASE_URL + '/public/img/fotos_usuarios/'+ FOTO_EMPLEADO +'" alt="Foto">',
