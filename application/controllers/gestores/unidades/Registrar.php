  ...
  // --------------------------------------------------------------
    ...
    public function form_registrar()
    {
         ...
         if( $this->verify_role('admin') )
        {
            ...
            $this->load->view('gestores/unidades/vista_registrar' );
        }
        ...
        if(  $this->auth_role == 'admin'    )
        {
            ...
            {                                          
			  ...
			  $this->form_registrar();
				...
				//guardar en la BD
				$this->load->model('gestores/unidades/Model_registrar');
                $result =  $this->Model_registrar->guardar_unidad($post);
                 ...
                 if ($result == true ) {
                     ...
                     $this->session->set_flashdata('estado_registro', 'registrado');
						...
						if($post['btn_subir'] == 'permanecer') 
	            			redirect('gestores/unidades/registrar/form_registrar', 'refresh');
                    ...
                    //registro Correcto, entonces mostramos mensaje y cargamos de nuevo vista registrar  
                     ...
                     redirect('gestores/unidades/listar/listar_colegios', 'refresh');
                 }                 
    ...
    {               
        ...
        $this->form_validation->set_rules('txt_nombre', 'Nombre', 'required|trim|min_length[3]|max_length[80]|is_unique[tbl_unidades.nombre_unidad]' ,
