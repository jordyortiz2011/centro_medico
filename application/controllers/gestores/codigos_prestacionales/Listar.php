  ...
  // --------------------------------------------------------------
    ...
    public function listar_codigos()
    {
        ...
        if(  $this->auth_role == 'admin' )
        {
            ...
            $this->load->view('gestores/codigos_prestacionales/vista_listar' , $data);
    ...
    public function listar_codigos_ajax()
    {
        ...
        {       
			...
			//echo "search cole: " . $search_tipo_cole;exit;
		 	...
		 	$this->load->model('gestores/codigos_prestacionales/Model_listar') ;
	        ...
	        if(!empty($posts))
	        {
	        	...
	        	foreach ($posts as $post)
	            {
					...
					$nestedData['id_registro'] = $post->id_codigo_prestacion; //para hacer la eliminacion
					
					$nestedData['codigo'] = $post->codigo_codpre;

                    $nestedData['descripcion'] = $post->descripcion_codpre;
