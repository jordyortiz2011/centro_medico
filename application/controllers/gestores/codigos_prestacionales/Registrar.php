  ...
  // --------------------------------------------------------------
    ...
    public function form_registrar()
    {
         ...
         if( $this->verify_role('admin') )
        {
            ...
            $this->load->view('gestores/codigos_prestacionales/vista_registrar' );
        }
        ...
        if(  $this->auth_role == 'admin'    )
        {
            ...
            {                                          
			  ...
			  $this->form_registrar();
				...
				//guardar en la BD
				$this->load->model('gestores/codigos_prestacionales/Model_registrar');
                $result =  $this->Model_registrar->guardar_prestacion($post);
                 ...
                 if ($result == true ) {
                     ...
                     $this->session->set_flashdata('estado_registro', 'registrado');
						...
						if($post['btn_subir'] == 'permanecer') 
	            			redirect('gestores/codigos_prestacionales/registrar/form_registrar', 'refresh');
