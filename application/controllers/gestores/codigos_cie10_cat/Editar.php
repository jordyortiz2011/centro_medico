...
class Editar extends MY_Controller {
 ...
 // --------------------------------------------------------------
     ...
     */   	 
	  ...
	  public function form_editar($id_registro = null){
        ...
        if(  $this->auth_role == 'admin' )
        {
        	 ...
        	 if($id_registro == null )
			  redirect('gestores/codigos_cie10_cat/listar/listar_codigos');
         
         	 //cargar librería de formulario
         	 $this->load->helper('form');
			
         	 //obtener los datos del registro
         	 $this->load->model('gestores/codigos_cie10_cat/Model_editar');
             ...
             $this->load->view('gestores/codigos_cie10_cat/vista_editar', $data)  ;
	...
	private function mi_validacion_editar ($post) 
	{
		...
		//Para el codigo
		if($codigo->codigo_ciecat != $post['text_codigo'])
		{
		  //para el código
        ...
        //Para la descripcion
        if($codigo->descripcion_ciecat != $post['text_descripcion'])
        {
