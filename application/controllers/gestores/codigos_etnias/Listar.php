  ...
  // --------------------------------------------------------------
    ...
    public function listar_codigos()
    {
        ...
        if(  $this->auth_role == 'admin' )
        {
            ...
            $this->load->view('gestores/codigos_etnias/vista_listar' , $data);
    ...
    public function listar_codigos_ajax()
    {
        ...
        {       
			...
			//echo "search cole: " . $search_tipo_cole;exit;
		 	...
		 	$this->load->model('gestores/codigos_etnias/Model_listar') ;
	        ...
	        if(!empty($posts))
	        {
	        	...
	        	foreach ($posts as $post)
	            {
					...
					$nestedData['id_registro'] = $post->id_codigo_etnia; //para hacer la eliminacion
					
					$nestedData['codigo'] = $post->codigo_codet;

                    $nestedData['descripcion'] = $post->descripcion_codet;
