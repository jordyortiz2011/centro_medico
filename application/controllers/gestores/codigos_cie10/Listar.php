  ...
  // --------------------------------------------------------------
    ...
    public function listar_codigos()
    {
        ...
        if(  $this->auth_role == 'admin' )
        {
            ...
            $this->load->view('gestores/codigos_cie10/vista_listar' , $data);
    ...
    public function listar_codigos_ajax()
    {
        ...
        {       
			...
			//echo "search cole: " . $search_tipo_cole;exit;
		 	...
		 	$this->load->model('gestores/codigos_cie10/Model_listar') ;
	        ...
	        if(!empty($posts))
	        {
	        	...
	        	foreach ($posts as $post)
	            {
					...
					$nestedData['id_registro'] = $post->id_codigo_cie10; //para hacer la eliminacion
					
					$nestedData['codigo'] = $post->codigo_cie10;

                    $nestedData['descripcion'] = $post->descripcion_cie10;
    ...
    public function eliminar_registro_fisico($id_registro = null)
    {
        ...
        if(  $this->auth_role == 'admin' )
        {
			...
			//comprobar si el registro está siendo usado en otra tabla
             $this->load->model('gestores/codigos_cie10/Model_listar') ;
			//$usado = $this->Model_listar->comprobar_registro($id_registro);
            $usado = false;
