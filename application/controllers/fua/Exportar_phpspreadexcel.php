...
class Exportar_phpspreadexcel extends MY_Controller {
    ...
    public function excel_reporte_solicitud ($id_registro = false) {
        ...
        if( $this->auth_level == 9 || $this->auth_level == 7  )
        {
            ...
            $inputFileType = 'Xlsx';
            $inputFileName = "public/docs/solicitud/plantilla_solicitud.xlsx";
            ...
            //meta datos
            //$sheet->setCellValue('A1', 'Hello World !');
            $sheet->setCellValue("C2", $solicitud->id_soli );
            $sheet->setCellValue("C3", fecha_transformar_fecha($solicitud->fecha_registro_soli) );
            $sheet->setCellValue("H2", $string_agencia );
            $sheet->setCellValue("H3", $solicitud->nombre_user_articulador_soli );
            $sheet->setCellValue("C4", fecha_transformar_fecha($solicitud->fecha_verificacion_soli) );
            $sheet->setCellValue("H4", $solicitud->nombre_user_asesor_destino_soli );
            //TITULAR
            $sheet->setCellValue("E6", $solicitud->nombres_titular_soli . " ".$solicitud->apellido_pat_titular_soli ." ".$solicitud->apellido_mat_titular_soli);
            $sheet->setCellValue("C7", $string_estado_civil );
            $sheet->setCellValue("G7", $solicitud->fecha_naci_titular_soli );
            $sheet->setCellValue("K7", $solicitud->dni_titular_soli );

            $sheet->setCellValue("C8", $string_tenencia_vivienda);
            $sheet->setCellValue("G8", $solicitud->numero_hijos_soli );

            $sheet->setCellValue("C9", $string_servicios_basicos );
            $sheet->setCellValue("G9", $solicitud->celular_titular_soli );
            $sheet->setCellValue("K9", $string_grado_titular );

            //Zonas titular
            $sheet->setCellValue("C10", $string_departamento );
            $sheet->setCellValue("G10", $string_provincia );
            $sheet->setCellValue("K10", $string_distrito );

            //DATOS FAMILIARES
            $sheet->setCellValue("E11", $solicitud->direccion_soli );
            $sheet->setCellValue("E12", $solicitud->direccion_terreno_soli );


            //Actividad principal - titular
            $sheet->setCellValue("C13", $solicitud->actividad_principal_titular_soli );
            $sheet->setCellValue("G13", $string_terreno_principal );
            $sheet->setCellValue("K13", $solicitud->area_principal_titular_soli );

            //Actividad Secundaria  - titular
            $sheet->setCellValue("C14", $solicitud->actividad_secundaria_titular_soli );
            $sheet->setCellValue("G14", $string_terreno_secundario );
            $sheet->setCellValue("K14", $solicitud->area_secundaria_titular_soli );
            //tipo de socio y número de créditos
            $sheet->setCellValue("C15", $string_tipo_socio );
            $sheet->setCellValue("G15", $solicitud->numero_creditos_soli );
            //Vendre producción a :
            $sheet->setCellValue("C16", $checkbox_vende_produccion['asociacion'] );
            $sheet->setCellValue("E16", $checkbox_vende_produccion['cooperativa'] );
            $sheet->setCellValue("G16", $checkbox_vende_produccion['comite'] );
            $sheet->setCellValue("I16", $checkbox_vende_produccion['intermediario'] );

            //$inicio_fila = 20;

            //CONYUGE
            $sheet->setCellValue("E18", $solicitud->nombres_conyugue_soli . " ".$solicitud->apellido_pat_conyugue_soli ." ".$solicitud->apellido_mat_conyugue_soli);
            $sheet->setCellValue("C19", $string_grado_conyugue );
            $sheet->setCellValue("G19", $solicitud->fecha_naci_conyugue_soli );
            $sheet->setCellValue("K19", $solicitud->dni_conyugue_soli );
            $sheet->setCellValue("C20", $solicitud->celular_conyugue_soli );
            $sheet->setCellValue("K20", $solicitud->fecha_naci_conyugue_soli );          ;
            ...
            //AVAL
            $sheet->setCellValue("E22", $solicitud->nombres_aval_soli . " ".$solicitud->apellido_pat_aval_soli ." ".$solicitud->apellido_mat_aval_soli);
            $sheet->setCellValue("C23", $solicitud->celular_aval_soli );
            $sheet->setCellValue("G23", $solicitud->fecha_naci_aval_soli );
            $sheet->setCellValue("K23", $solicitud->dni_aval_soli );
            $sheet->setCellValue("C24", $solicitud->direccion_aval_soli );


            //Aplicar formula de edad sólo si hay fecha de nacimiento
            if( $solicitud->fecha_naci_aval_soli == NULL ||  $solicitud->fecha_naci_aval_soli == '') {
                $sheet->setCellValue("K24", "" );
            }

            //CONYUGUE DEL AVAL
            $sheet->setCellValue("E26", $solicitud->nombres_conyu_aval_soli . " ".$solicitud->apellido_pat_conyu_aval_soli ." ".$solicitud->apellido_mat_conyu_aval_soli);
            $sheet->setCellValue("C27", $solicitud->celular_conyu_aval_soli );
            $sheet->setCellValue("G27", $solicitud->fecha_naci_conyu_aval_soli );
            $sheet->setCellValue("K27", $solicitud->dni_conyu_aval_soli );
            ...
            $fila_datos_adicional = $inicio_fila - 2 ;
            $sheet
            ...
            if($solicitud->registra_deuda_titular_soli == 'SI') {
                ...
                $spreadsheet->getActiveSheet()->getStyle("C$fila_datos_adicional:D$fila_datos_adicional")->applyFromArray($styleArray);
            }
            ...
            if(!empty($tabla_deuda_titular))
            {
                ...
                //echo $cant_registros_titular; exit;

                $spreadsheet->getActiveSheet()->insertNewRowBefore(33 , $cant_registros_titular );
                ...
                foreach ($tabla_deuda_titular as $deuda)
                {
                    ...
                    $spreadsheet->getActiveSheet()->mergeCells("D$inicio_fila:E$inicio_fila");

                     //combinar celdas (Peor calificación)
                    $spreadsheet->getActiveSheet()->mergeCells("G$inicio_fila:H$inicio_fila");
                ...
                $spreadsheet->getActiveSheet()->getStyle("B$inicio_fila_titular:K$inicio_fila")->applyFromArray($styleArray);

                $spreadsheet->getActiveSheet()->getStyle("B$inicio_fila_titular:K$inicio_fila")
                ...
                $spreadsheet->getActiveSheet()->mergeCells("B$inicio_fila:C$inicio_fila");
                ...
                $spreadsheet->getActiveSheet()->getStyle("B$inicio_fila:K$inicio_fila")->applyFromArray($styleArray);

                $spreadsheet->getActiveSheet()->getStyle("B$inicio_fila:K$inicio_fila")
                    ->getAlignment()->setWrapText(true);
            ...
            $inicio_fila = 36 + $cant_registros_titular;
            ...
            if(!empty($tabla_deuda_conyuge))
            {
                ...
                $spreadsheet->getActiveSheet()->insertNewRowBefore(37 + $cant_registros_titular  , $cant_registros_conyuge );
                ...
                $spreadsheet->getActiveSheet()->getStyle("B$inicio_fila_conyuge:K$inicio_fila")->applyFromArray($styleArray);

                $spreadsheet->getActiveSheet()->getStyle("B$inicio_fila_conyuge:K$inicio_fila")
                    ->getAlignment()->setWrapText(true);
            ...
            $inicio_fila = 39 + $cant_registros_titular + $cant_registros_conyuge;
            ...
            if(!empty($tabla_cultivo))
            {
                ...
                $spreadsheet->getActiveSheet()->insertNewRowBefore(40 + $cant_registros_titular + $cant_registros_conyuge  , $cant_registros_cultivo );
                ...
                foreach ($tabla_cultivo as $cultivo)
                {
                    ...
                    //combinar celdas (Peor calificación)
                    $spreadsheet->getActiveSheet()->mergeCells("J$inicio_fila:K$inicio_fila");
                ...
                $spreadsheet->getActiveSheet()->getStyle("B$inicio_fila_cultivo:K$fin_fila_cultivo")->applyFromArray($styleArray);

                $spreadsheet->getActiveSheet()->getStyle("B$inicio_fila_cultivo:K$fin_fila_cultivo")
                    ->getAlignment()->setWrapText(true);
                ...
                //combinar celdas (TOTAL: texto)
                $spreadsheet->getActiveSheet()->mergeCells("B$inicio_fila:I$inicio_fila");
                //combinar celdas (TOTAL: Saldo de deuda a la fecha)
                $spreadsheet->getActiveSheet()->mergeCells("J$inicio_fila:K$inicio_fila");
            ...
            $inicio_fila = 42 + $cant_registros_titular + $cant_registros_conyuge + $cant_registros_cultivo ;
            ...
            if(!empty($tabla_pecuaria))
            {
                ...
                //$cant_registros_conyuge = $cant_registros_conyuge - 1 ;
                $spreadsheet->getActiveSheet()->insertNewRowBefore(43 + $cant_registros_titular + $cant_registros_conyuge + $cant_registros_cultivo , $cant_registros_pecuaria );
                ...
                $spreadsheet->getActiveSheet()->getStyle("B$inicio_fila_pecuaria:K$fin_fila_pecuaria")->applyFromArray($styleArray);

                $spreadsheet->getActiveSheet()->getStyle("B$inicio_fila_pecuaria:K$fin_fila_pecuaria")
                    ->getAlignment()->setWrapText(true);
            ...
            //1ero eliminar datos de la tabla de deuda financiera del conyuge
            ...
            if($solicitud->id_estado_civil_soli == 1 || $solicitud->id_estado_civil_soli == 3 || $solicitud->id_estado_civil_soli == 5 ) {
                ...
                $spreadsheet->getActiveSheet()->removeRow($inicio_fila_conyuge   );
                $spreadsheet->getActiveSheet()->removeRow($inicio_fila_conyuge - 1  );
                $spreadsheet->getActiveSheet()->removeRow($inicio_fila_conyuge - 2  );
                $spreadsheet->getActiveSheet()->removeRow($inicio_fila_conyuge - 3  );
            }

            //comprobar si el TITULAR tiene aval
            if($solicitud->id_posee_aval_soli  == 0 ) {
                $spreadsheet->getActiveSheet()->removeRow(22 , 6  );
            }

            //1=Soltero 3=viudo 5=divorciado
            if($solicitud->id_estado_civil_soli == 1 || $solicitud->id_estado_civil_soli == 3 || $solicitud->id_estado_civil_soli == 5 ) {
                $spreadsheet->getActiveSheet()->removeRow(17 , 5  );
            }
    ...
    public function pdf_reporte_solicitud ($id_registro = false) {
        ...
        if( $this->auth_level == 9 || $this->auth_level == 7  )
        {
            ...
            $writer->setPaperSize(\PhpOffice\PhpSpreadsheet\Worksheet\PageSetup::PAPERSIZE_A2_PAPER);
            $writer->save('php://output'); // download file
            exit;
