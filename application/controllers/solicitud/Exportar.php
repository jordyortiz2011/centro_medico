...
class Exportar extends MY_Controller {
    ...
    public function excel_reporte_solicitud ($id_registro = false) {
        ...
        if( $this->auth_level == 9 || $this->auth_level == 8 ||$this->auth_level == 7 || $this->auth_level == 4 || $this->auth_level == 3 )
        {
            ...
            $objPHPExcel->setActiveSheetIndex()->setCellValue("C2", $solicitud->id_soli );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("C3", fecha_transformar_fecha($solicitud->fecha_registro_soli) );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("H2", $string_agencia );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("H3", $solicitud->nombre_user_articulador_soli );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("C4", fecha_transformar_fecha($solicitud->fecha_verificacion_soli) );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("H4", $solicitud->nombre_user_asesor_destino_soli );
            //TITULAR
            $objPHPExcel->setActiveSheetIndex()->setCellValue("E6", $solicitud->nombres_titular_soli . " ".$solicitud->apellido_pat_titular_soli ." ".$solicitud->apellido_mat_titular_soli);
            $objPHPExcel->setActiveSheetIndex()->setCellValue("C7", $string_estado_civil );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("G7", $solicitud->fecha_naci_titular_soli );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("K7", $solicitud->dni_titular_soli );

            $objPHPExcel->setActiveSheetIndex()->setCellValue("C8", $string_tenencia_vivienda);
            $objPHPExcel->setActiveSheetIndex()->setCellValue("G8", $solicitud->numero_hijos_soli );

            $objPHPExcel->setActiveSheetIndex()->setCellValue("C9", $string_servicios_basicos );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("G9", $solicitud->celular_titular_soli );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("K9", $string_grado_titular );

            //Zonas titular
            $objPHPExcel->setActiveSheetIndex()->setCellValue("C10", $string_departamento );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("G10", $string_provincia );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("K10", $string_distrito );

            //DATOS FAMILIARES
            $objPHPExcel->setActiveSheetIndex()->setCellValue("E11", $solicitud->direccion_soli );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("E12", $solicitud->direccion_terreno_soli );


            //Actividad principal - titular
            $objPHPExcel->setActiveSheetIndex()->setCellValue("C13", $solicitud->actividad_principal_titular_soli );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("G13", $string_terreno_principal );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("K13", $solicitud->area_principal_titular_soli );

            //Actividad Secundaria  - titular
            $objPHPExcel->setActiveSheetIndex()->setCellValue("C14", $solicitud->actividad_secundaria_titular_soli );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("G14", $string_terreno_secundario );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("K14", $solicitud->area_secundaria_titular_soli );
            //tipo de socio y número de créditos
            $objPHPExcel->setActiveSheetIndex()->setCellValue("C15", $string_tipo_socio );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("G15", $solicitud->numero_creditos_soli );
            //Vendre producción a :
            $objPHPExcel->setActiveSheetIndex()->setCellValue("C16", $checkbox_vende_produccion['asociacion'] );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("E16", $checkbox_vende_produccion['cooperativa'] );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("G16", $checkbox_vende_produccion['comite'] );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("I16", $checkbox_vende_produccion['intermediario'] );

            //$inicio_fila = 20;

            //CONYUGE
            $objPHPExcel->setActiveSheetIndex()->setCellValue("E18", $solicitud->nombres_conyugue_soli . " ".$solicitud->apellido_pat_conyugue_soli ." ".$solicitud->apellido_mat_conyugue_soli);
            $objPHPExcel->setActiveSheetIndex()->setCellValue("C19", $string_grado_conyugue );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("G19", $solicitud->fecha_naci_conyugue_soli );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("K19", $solicitud->dni_conyugue_soli );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("C20", $solicitud->celular_conyugue_soli );
                     ;
            ...
            if( $solicitud->fecha_naci_conyugue_soli == NULL ||  $solicitud->fecha_naci_conyugue_soli == '') {
                $objPHPExcel->setActiveSheetIndex()->setCellValue("K20", "" );
            }

            //AVAL
            $objPHPExcel->setActiveSheetIndex()->setCellValue("E22", $solicitud->nombres_aval_soli . " ".$solicitud->apellido_pat_aval_soli ." ".$solicitud->apellido_mat_aval_soli);
            $objPHPExcel->setActiveSheetIndex()->setCellValue("C23", $solicitud->celular_aval_soli );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("G23", $solicitud->fecha_naci_aval_soli );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("K23", $solicitud->dni_aval_soli );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("C24", $solicitud->direccion_aval_soli );


            //Aplicar formula de edad sólo si hay fecha de nacimiento
            if( $solicitud->fecha_naci_aval_soli == NULL ||  $solicitud->fecha_naci_aval_soli == '') {
                $objPHPExcel->setActiveSheetIndex()->setCellValue("K24", "" );
            }

            //CONYUGUE DEL AVAL
            $objPHPExcel->setActiveSheetIndex()->setCellValue("E26", $solicitud->nombres_conyu_aval_soli . " ".$solicitud->apellido_pat_conyu_aval_soli ." ".$solicitud->apellido_mat_conyu_aval_soli);
            $objPHPExcel->setActiveSheetIndex()->setCellValue("C27", $solicitud->celular_conyu_aval_soli );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("G27", $solicitud->fecha_naci_conyu_aval_soli );
            $objPHPExcel->setActiveSheetIndex()->setCellValue("K27", $solicitud->dni_conyu_aval_soli );
            ...
            //echo $fila_datos_adicional; exit;
            ...
            if($solicitud->registra_deuda_titular_soli == 'SI') {
                ...
                $objPHPExcel->getActiveSheet()->getStyle("C$fila_datos_adicional:D$fila_datos_adicional")->applyFromArray($styleArray);
            }
            ...
            if(!empty($tabla_deuda_conyuge))
            {
                ...
                $objPHPExcel->getActiveSheet()->insertNewRowBefore(37 + $cant_registros_titular  , $cant_registros_conyuge );
            ...
            if(!empty($tabla_cultivo))
            {
                ...
                $objPHPExcel->getActiveSheet()->insertNewRowBefore(40 + $cant_registros_titular + $cant_registros_conyuge  , $cant_registros_cultivo );
            ...
            if(!empty($tabla_pecuaria))
            {
                ...
                //$cant_registros_conyuge = $cant_registros_conyuge - 1 ;
                $objPHPExcel->getActiveSheet()->insertNewRowBefore(43 + $cant_registros_titular + $cant_registros_conyuge + $cant_registros_cultivo , $cant_registros_pecuaria );
            ...
            if($solicitud->id_estado_civil_soli == 1 || $solicitud->id_estado_civil_soli == 3 || $solicitud->id_estado_civil_soli == 5 ) {
                ...
                $objPHPExcel->getActiveSheet()->removeRow($inicio_fila_conyuge   );
                $objPHPExcel->getActiveSheet()->removeRow($inicio_fila_conyuge - 1  );
                $objPHPExcel->getActiveSheet()->removeRow($inicio_fila_conyuge - 2  );
                $objPHPExcel->getActiveSheet()->removeRow($inicio_fila_conyuge - 3  );
            }

            //comprobar si el TITULAR tiene aval
            if($solicitud->id_posee_aval_soli  == 0 ) {
                $objPHPExcel->getActiveSheet()->removeRow(22 , 6  );
            }

            //1=Soltero 3=viudo 5=divorciado
            if($solicitud->id_estado_civil_soli == 1 || $solicitud->id_estado_civil_soli == 3 || $solicitud->id_estado_civil_soli == 5 ) {
                $objPHPExcel->getActiveSheet()->removeRow(17 , 5  );
            }
