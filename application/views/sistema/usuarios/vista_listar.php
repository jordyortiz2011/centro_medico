...
<?php  $data = array (  
                        'navegacion'    => array ('Sistema'  => '' , 'Usuarios' => '' , 'Listar' => '#' ),
		        	...
		        	<div class="card" style="margin-bottom: 10px;">
					    ...
					    <div  class="card-body collapse show" id="card_filtros" >
					    	...
					    	<div class="form-group row">
	                          ...
	                          <div class="col-sm-5">
	                            <select class="select2"  name="filtrado_tipo_usuario" id="filtrado_tipo_usuario" data-width="100%">
                 ...
                 <div class="card">
                    <div class="card-header d-flex align-items-center " style="height: 4em;">
	                     <h3 class="h4"><i class="fa fa-list" aria-hidden="true"></i> Listado</h3>
						   <div class="card-close ">	                        
		                        <a type="button" class="btn btn-info" href="<?= base_url('sistema/usuarios/agregar/form_agregar') ?>"> 
                    ...
                    <div class="card-body">
                    	<div class="table-responsive">
                    		 <table id="listado_usuarios" class="display nowrap table table-striped table-bordered">
 ...
 $data = array (
                'javascripts' => array (
                						 //Select2 (colegio)
	                                      ...
	                                      'recursos/sistema/usuarios/js/listar_eliminar_usuarios.js' ,                                                                               
                                       )
                );  
