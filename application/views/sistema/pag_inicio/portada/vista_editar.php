          ...
          <div class="row justify-content-center">
          	 ...
          	 <!--empieza contenido lado izquierdo-->
                ...
                <?php echo validation_errors('<div class="col-sm-12 text-center" style="margin-bottom: 1px;"><buttom class="btn btn-round btn-danger col-center">', '</buttom></div>'); ?> 
                      ...
                      <form id="form_agregar_portada" method="POST" action="<?= base_url('sistema/pag_inicio/portada/agregar/procesa_editar') ?>" method="POST" enctype="multipart/form-data" >
                          <input type="hidden" name="hidd_id_porta" value="<?=  $portada->id_porta ?>" />
                        ...
                        <div class="row">
                        	...
                        	<div class="col-12 col-md-6">
		 						...
		 						<!-- Título-->	                        	
	                        		<div class="form-group row">
			  							<label for="txt_nombres"  class="col-12 col-md-4 col-form-label-lg">Título <span class="text-danger d-none conten_danger ">*</span> </label>
			  							  <div class="col-12 col-md-7">
			  							  	<div class="validacion">
			  							  		<input type="text" class="form-control form-control-lg"  id="txt_titulo" name="txt_titulo" placeholder="Ingrese Título"  autocomplete="off" value="<?=  $portada->titulo_porta; ?>">
                        		...
                        		<div class="form-group row">
		  							<label for="txt_direccion"  class="col-12 col-md-4 col-form-label-lg">Descripción</label>
		  							  <div class="col-12 col-md-7">
		  							  	<div class="validacion">
		  							  		<textarea class="form-control form-control-lg"  id="txt_descripcion" name="txt_descripcion"   autocomplete="off" ><?= $portada->descrip_porta; ?></textarea>
		  							  	</div>     							
		    						  </div>
		 						</div>
		  							...
		  							<label for="txt_jornada"  class="col-12 col-md-4 col-form-label-lg">Prioridad <span class="text-danger">*</span>
		  							  ...
		  							  <div class="col-12 col-md-5">
		     							<input type="text" class="form-control form-control-lg text-center"  id="txt_prioridad" name="txt_prioridad"
		     							 placeholder="Ingrese "  autocomplete="off" style="display: inline-block; width: 70%; margin-right: 0.5em;" value="<?=  $portada->prioridad_porta; ?>">
		    						  </div>
		 						</div>
                        	...
                        	<div class="col-12 col-md-6">
		 						...
		 						<!-- Foto -->
                        		<div class="form-group row <?= $portada->tipo_porta == 1 ? ' ' : 'd-none' ?>" id="conten_imagen">
		 						...
		 						<div class="form-group row conten_color <?= $portada->tipo_porta == 2 ? ' ' : 'd-none' ?>">
                        		...
                        		<div class="form-group row">
		  							<label for="txt_direccion"  class="col-12 col-md-3 col-form-label-lg">Activo 
		  							  ...
		  							  <div class="col-12 col-md-7">
		  							  	<br>
		  							  	<div class="validacion">
		  							  		 <input type="checkbox" name="checkbox_estado" <?= $portada->estado_porta == 1 ? 'checked' : ' ' ?> data-toggle="toggle"    data-on="SI" data-off="NO"
...
<!-- 3 =============       FOOTER          ========================= -->
<script>
    var FOTO_PORTADA = '<?= $portada->foto_porta; ?>';
</script>
<?php
    //ruta por defecto es public/
 $data = array (
