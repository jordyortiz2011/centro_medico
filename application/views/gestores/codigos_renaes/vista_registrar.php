...
<?php
    //ruta por defecto es public/
     $data = array (
                    'titulo_header' => 'Registrar Código RENAES',
                    'css'           => array (
                    						   //Select2
...
<?php  $data = array (  
                        'navegacion'    => array ('Gestores'  => '' , 'Código RENAES' => '' , 'Registrar' => '#' ),
                        'titulo'        => 'Registrar código RENAES' ,
          ...
          <div class="row justify-content-center">
          	 ...
          	 <!--empieza contenido lado izquierdo-->
                ...
                <?php echo validation_errors('<div class="col-sm-12 text-center" style="margin-bottom: 1px;"><buttom class="btn btn-round btn-danger col-center">', '</buttom></div>'); ?> 
                	<br>
                      <form method="POST" id="form_registrar_renae" action="<?= base_url('gestores/codigos_renaes/registrar/procesa') ?>">
                        <div class="form-group row">

  							<label for="txt_nombre"  class="col-sm-4 col-form-label">Código RENAES <span class="text-red">(*)</span></label>
  							  <div class="col-sm-3">
  							  	<div class="validacion">
  							  		<input type="text" class="form-control numeric" id="text_cod_renaes" name="text_cod_renaes" placeholder="Ingrese campo" required="" maxlength="4" autocomplete="off" value="<?=  set_value('text_cod_renae'); ?>">
  							  	</div>     							
    						  </div>
 						</div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                  <div class="validacion">
                                      <input type="text" class="form-control" id="text_micro" name="text_micro" placeholder="Ingrese campo " required="" autocomplete="off" value="<?=  set_value('text_micro'); ?>">
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                  <div class="validacion">
                                      <input type="text" class="form-control" id="text_distrito" name="text_distrito" placeholder="Ingrese campo"  autocomplete="off" value="<?=  set_value('text_distrito'); ?>">
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                  <div class="validacion">
                                      <input type="text" class="form-control" id="text_codexcel" name="text_codexcel" placeholder="Ingrese campo"  autocomplete="off" value="<?=  set_value('text_codexcel'); ?>">
                                  </div>
                              </div>
                          </div>
