...
<?php  $data = array (  
                        'navegacion'    => array ('Gestores'  => '' , 'Unidades' => '' , 'Listar' => '#' ),
                        'titulo'        => 'Listar Unidades' ,
                 ...
                 <div class="card">
                    <div class="card-header d-flex align-items-center" style="height: 4em;">
                     <h3 class="h4"><i class="fa fa-list" aria-hidden="true"></i> Listado</h3>
                        <div class="card-close ">
                            <a type="button" class="btn btn-info" href="<?= base_url('gestores/unidades/registrar/form_registrar') ?>">
                    ...
                    <div class="card-body">
                    	<div class="table-responsive">
                    		 <table id="listado_unidades" class="display nowrap table table-striped table-bordered">
 ...
 $data = array (
                'javascripts' => array (
                						 //Select2 (colegio)
	                                      ...
	                                      'recursos/gestores/unidades/js/listar_eliminar_unidades.js' ,
                                       )
                );  
