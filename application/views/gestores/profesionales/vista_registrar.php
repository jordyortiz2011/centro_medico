...
<?php
    //ruta por defecto es public/
     $data = array (
                    'titulo_header' => 'Registrar profesional',
                    'css'           => array (
                    						   //Select2
...
<?php  $data = array (  
                        'navegacion'    => array ('Gestores'  => '' , 'Profesional' => '' , 'Nuevo' => '#' ),
          ...
          <div class="row justify-content-center">
          	 ...
          	 <!--empieza contenido lado izquierdo-->
                ...
                <?php echo validation_errors('<div class="col-sm-12 text-center" style="margin-bottom: 1px;"><buttom class="btn btn-round btn-danger col-center">', '</buttom></div>'); ?> 
                      ...
                      <form id="form_registrar_profesional" method="POST" action="<?= base_url('gestores/profesionales/registrar/procesa') ?>"  enctype="multipart/form-data" >
                        ...
                        <div class="row">
                        	...
                        	<div class="col-12 col-md-7">
		  							...
		  							<label for="txt_apellido_pat"  class="col-12 col-md-4 col-form-label-lg">Apellido Paterno <span class="text-danger">*</span></label>
		  							  <div class="col-12 col-md-7">
		  							  	<div class="validacion">
		  							  		<input type="text" class="form-control form-control-lg"  id="text_apellido_pat" name="text_apellido_pat" placeholder="Ingrese campo" required="" autocomplete="off" value="<?=  set_value('text_apellido_pat'); ?>">
		  							  	</div>     							
		    						  </div>
		 						</div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-md-7">
                                        <div class="validacion">
                                            <input type="text" class="form-control form-control-lg"  id="text_apellido_mat" name="text_apellido_mat" placeholder="Ingrese campo" required="" autocomplete="off" value="<?=  set_value('text_apellido_mat'); ?>">
                                        </div>
                                    </div>
                                </div>
                        	...
                        	<div class="col-12 col-md-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-md-7">
                                        <div class="validacion">
                                            <input type="text" class="form-control form-control-lg"  id="text_dni" name="text_dni" placeholder="Ingrese campo" maxlength="8"  autocomplete="off" value="<?=  set_value('text_dni'); ?>">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                              ...
                              <div class="col-12 col-md-7">
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-12 col-md-7">
                                          <div class="validacion">
                                              <select class="select2"  name="select_especialidad" id="select_especialidad" data-width="100%">
                                                  <option value="" selected="">Seleccione</option>
                                                  <?php foreach ($lst_especialidades as $espe) {?>
                                                      <option value="<?= $espe -> id_especialidad ?>"><?= $espe -> nombre_espe ?></option>
                                                  <?php } ?>
                                              </select>
                                          </div>
                                      </div>
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-12 col-md-7">
                                          <div class="validacion">
                                              <input type="text" class="form-control form-control-lg"  id="text_username" name="text_username"  maxlength="15" autocomplete="off"  value="<?=  set_value('text_username'); ?>">
                              ...
                              <div class="col-12 col-md-5">
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-12 col-md-7">
                                          <div class="validacion">
                                              <input type="text" class="form-control form-control-lg"  id="text_correo" name="text_correo" placeholder="Ingrese Correo" required="" autocomplete="off" value="<?=  set_value('text_correo'); ?>">
                                          </div>
                                      </div>
                                  </div>
 ...
 $data = array (
                'javascripts' => array (
                						 //Select2 (colegio)
                    					  ...
                    					  //librería general
                    					  'recursos/gestores/profesionales/js/registrar.js',
