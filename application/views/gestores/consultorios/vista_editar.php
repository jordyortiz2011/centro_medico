...
<?php
    //ruta por defecto es public/
     $data = array (
                    'titulo_header' => 'Editar consultorio',
                    'css'           => array (
                    						   //Select2
...
<?php  $data = array (  
                        'navegacion'    => array ('Gestores'  => '' , 'Consultorios' => '' , 'Editar' => '#' ),
          ...
          <div class="row justify-content-center">
          	 ...
          	 <!--empieza contenido lado izquierdo-->
                ...
                <?php echo validation_errors('<div class="col-sm-12 text-center" style="margin-bottom: 1px;"><buttom class="btn btn-round btn-danger col-center">', '</buttom></div>'); ?> 
                	<br>
                      <form method="POST" id="form_registrar_especialidad" action="<?= base_url('gestores/consultorios/editar/procesa_editar') ?>">
                          <input type="hidden" name="hidd_id_consultorio" value="<?= $consultorio->id_consultorio ?>" />

                          <div class="form-group row">
  							<label for="txt_nombre"  class="col-sm-4 col-form-label">Nombre de consultorio<span class="text-red">(*)</span></label>
  							  <div class="col-sm-8">
  							  	<div class="validacion">
  							  		<input type="text" class="form-control " id="text_nombre" name="text_nombre" placeholder="Ingrese campo" required="" maxlength="100" autocomplete="off" value="<?=  $consultorio->nombre_consul ?>">
  							  	</div>     							
    						  </div>
 						    </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-3">
                                  <div class="validacion">
                                      <input type="text" class="form-control reloj " id="text_hora_inicio" name="text_hora_inicio" placeholder="HH:MM" required=""  autocomplete="off" value="<?=  $hora_inicio ?>">
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-3">
                                  <div class="validacion">
                                      <input type="text" class="form-control reloj" id="text_hora_fin" name="text_hora_fin" placeholder="HH:MM" required=""  autocomplete="off" value="<?=  $hora_fin ?>">
                                  </div>
                              </div>
                          </div>
