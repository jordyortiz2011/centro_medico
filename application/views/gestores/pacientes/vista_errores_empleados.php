...
<?php  $data = array (  
                        'navegacion'    => array ('Gestores'  => '' , 'Ciclos' => '' , 'Registrar' => '#' ),
                        'titulo'        => 'Ciclo' ,
                        'titulo_icono'  => 'fa fa-graduation-cap',
                        'descripcion'   => 'Error al registrar Ciclo' 
          	 ...
          	 <!--empieza contenido lado izquierdo-->
                 <div class="col-md-11">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
               			<?php if( isset($sin_aulas) ) { ?>
               				<div class="alert alert-danger" role="alert">
							  <h4 class="alert-heading">No hay Aulas</h4>
							  <p>No hay aulas disponibles para realizar el registro de ciclo</p>
							  <hr>
							  <p class="mb-0">
							  	Dirijase al módulo <strong> <a href="<?= base_url('gestores/aulas/registrar/form_registrar') ?>"> </strong>Registrar Aula</a> y añada un aula
							  </p>
							</div>
               			<?php } ?>
                    </div>
