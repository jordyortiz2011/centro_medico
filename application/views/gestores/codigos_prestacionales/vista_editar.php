...
<?php
    //ruta por defecto es public/
     $data = array (
                    'titulo_header' => 'Editar Código Prestacional',
                    'css'           => array (
                    						   //Select2
...
<?php  $data = array (  
                        'navegacion'    => array ('Gestores'  => '' , 'Códigos Prestacionales' => '' , 'Editar' => '#' ),
                        'titulo'        => 'Editar código Prestacional' ,
          ...
          <div class="row justify-content-center">
          	 ...
          	 <!--empieza contenido lado izquierdo-->
                ...
                <?php echo validation_errors('<div class="col-sm-12 text-center" style="margin-bottom: 1px;"><buttom class="btn btn-round btn-danger col-center">', '</buttom></div>'); ?> 
                	<br>
                      <form method="POST" id="form_registrar_etnia" action="<?= base_url('gestores/codigos_prestacionales/editar/procesa_editar') ?>">
                        <input type="hidden" name="hidden_id_codigo" id="hidden_id_codigo" value="<?= $codigo->id_codigo_prestacion; ?>" >
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-3">
                                  <div class="validacion">
                                      <input type="text" class="form-control" id="text_codigo" name="text_codigo" placeholder="Ingrese campo "  autocomplete="off" value="<?=  $codigo->codigo_codpre; ?>">
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <label for="txt_nombre"  class="col-sm-4 col-form-label">Servicio <span class="text-red">*</span> </label>
                              <div class="col-sm-8">
                                  <div class="validacion">
                                      <input type="text" class="form-control" id="text_descripcion" name="text_descripcion" placeholder="Ingrese campo"  autocomplete="off" value="<?=  $codigo->descripcion_codpre; ?>">
                                  </div>
                              </div>
                          </div>
 ...
 $data = array (
                'javascripts' => array (
                                        ...
                                        'librerias/numeric/jquery.numeric.min.js',
                    					  ...
                    					  //librería general
                    					  'recursos/gestores/codigos_prestacionales/js/registrar.js',
