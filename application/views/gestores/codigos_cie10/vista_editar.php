...
<?php
    //ruta por defecto es public/
     $data = array (
                    'titulo_header' => 'Editar Código CIE-10 Descripción',
                    'css'           => array (
                    						   //Select2
...
<?php  $data = array (  
                        'navegacion'    => array ('Gestores'  => '' , 'Códigos CIE-10' => '' ,  'Descripción' => '' , 'Editar' => '#' ),
                        'titulo'        => 'Editar Código CIE-10 Descripción' ,
          ...
          <div class="row justify-content-center">
          	 ...
          	 <!--empieza contenido lado izquierdo-->
                ...
                <?php echo validation_errors('<div class="col-sm-12 text-center" style="margin-bottom: 1px;"><buttom class="btn btn-round btn-danger col-center">', '</buttom></div>'); ?> 
                	<br>
                      <form method="POST" id="form_registrar_codigo" action="<?= base_url('gestores/codigos_cie10/editar/procesa_editar') ?>">
                            <input type="hidden" name="hidden_id_codigo" value="<?= $codigo->id_codigo_cie10 ?>">
                          <!-- especialidad -->
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-1" style="margin-right: 0px;  padding-right: 0px;">
                                  ...
                                  <div class="validacion">
                                      <input type="text" class="form-control" id="text_codigo_tres" name="text_codigo_tres"  maxlength="3" readonly autocomplete="off" value="<?=  $codigo_tres ?>">
                                  </div>
                              </div>

                              <div class="col-sm-1" style="margin-left: 0px; padding-left: 0px;">
                                  <div class="validacion">
                                      <input type="text" class="form-control" id="text_codigo" name="text_codigo" placeholder="Ingrese campo " maxlength="1" autocomplete="off" value="<?=  $ultimo_caracter ?>">
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                  <div class="validacion">
                                      <input type="text" class="form-control" id="text_descripcion" name="text_descripcion" placeholder="Ingrese campo"  autocomplete="off" value="<?= $codigo->descripcion_cie10 ?>">
                                  </div>
                              </div>
                          </div>
