...
<?php
    //ruta por defecto es public/
     $data = array (
                    'titulo_header' => 'Registrar Código CIE-10 Categoria',
                    'css'           => array (
                    						   //Select2
...
<?php  $data = array (  
                        ...
                        'titulo'        => 'Registrar Código CIE-10 Categoria' ,
          ...
          <div class="row justify-content-center">
          	 ...
          	 <!--empieza contenido lado izquierdo-->
                ...
                <?php echo validation_errors('<div class="col-sm-12 text-center" style="margin-bottom: 1px;"><buttom class="btn btn-round btn-danger col-center">', '</buttom></div>'); ?> 
                	<br>
                      <form method="POST" id="form_registrar_codigo" action="<?= base_url('gestores/codigos_cie10_cat/registrar/procesa') ?>">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-3">
                                  <div class="validacion">
                                      <input type="text" class="form-control" id="text_codigo" name="text_codigo" placeholder="Ingrese campo " maxlength="3" autocomplete="off" value="<?=  set_value('text_codigo'); ?>">
                                  </div>
                              </div>
                          </div>
