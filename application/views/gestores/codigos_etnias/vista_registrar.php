...
<?php
    //ruta por defecto es public/
     $data = array (
                    'titulo_header' => 'Registrar Código Etnias',
                    'css'           => array (
                    						   //Select2
...
<?php  $data = array (  
                        'navegacion'    => array ('Gestores'  => '' , 'Código Etnias' => '' , 'Registrar' => '#' ),
                        'titulo'        => 'Registrar código Etnias' ,
          ...
          <div class="row justify-content-center">
          	 ...
          	 <!--empieza contenido lado izquierdo-->
                ...
                <?php echo validation_errors('<div class="col-sm-12 text-center" style="margin-bottom: 1px;"><buttom class="btn btn-round btn-danger col-center">', '</buttom></div>'); ?> 
                	<br>
                      <form method="POST" id="form_registrar_etnia" action="<?= base_url('gestores/codigos_etnias/registrar/procesa') ?>">
