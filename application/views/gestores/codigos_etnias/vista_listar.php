...
<?php
    //ruta por defecto es public/
     $data = array (
                    'titulo_header' => 'Listar códigos Etnias',
                    'css'           => array (
                    						   //Select2
...
<?php  $data = array (  
                        'navegacion'    => array ('Gestores'  => '' , 'Códigos Etnias' => '' , 'Listar' => '#' ),
                        'titulo'        => 'Listar códigos Etnias' ,
                    ...
                    <div class="card-header d-flex align-items-center" style="height: 4em;">
                     <h3 class="h4"><i class="fa fa-list" aria-hidden="true"></i> Listado</h3>
                        <div class="card-close ">
                            <a type="button" class="btn btn-info" href="<?= base_url('gestores/codigos_etnias/registrar/form_registrar') ?>">
 ...
 $data = array (
                'javascripts' => array (
                						 //Select2 (colegio)
	                                      ...
	                                      'recursos/gestores/codigos_etnias/js/listar_eliminar_codigos.js' ,
                                       )
                );  
