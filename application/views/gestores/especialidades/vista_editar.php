...
<?php
    //ruta por defecto es public/
     $data = array (
                    'titulo_header' => 'Editar especialidad',
                    'css'           => array (
                    						   //Select2
...
<?php  $data = array (  
                        'navegacion'    => array ('Gestores'  => '' , 'Especialidades' => '' , 'Editar' => '#' ),
          ...
          <div class="row justify-content-center">
          	 ...
          	 <!--empieza contenido lado izquierdo-->
                ...
                <?php echo validation_errors('<div class="col-sm-12 text-center" style="margin-bottom: 1px;"><buttom class="btn btn-round btn-danger col-center">', '</buttom></div>'); ?> 
                	<br>
                      <form method="POST" id="form_registrar_especialidad" action="<?= base_url('gestores/especialidades/editar/procesa_editar') ?>">
                          <input type="hidden" name="hidd_id_especialidad" value="<?= $especialidad->id_especialidad ?>" />
  							...
  							<label for="txt_nombre"  class="col-sm-4 col-form-label">Nombre de Especialidad<span class="text-red">(*)</span></label>
  							  <div class="col-sm-8">
  							  	<div class="validacion">
  							  		<input type="text" class="form-control " id="text_nombre" name="text_nombre" placeholder="Ingrese campo" required="" maxlength="100" autocomplete="off" value="<?=  $especialidad->nombre_espe ?>">
  							  	</div>     							
    						  </div>
 						</div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-12 col-sm-4">
                                  <div class="clearfix input-group colorpicker-component" id="div_color">
                                      <input type="text" class="form-control" id="text_color" name="text_color" readonly=""  placeholder="Seleccione color" required="" autocomplete="off" value="<?=  $especialidad->color_espe ?>">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-12 col-sm-8">
                                  <div class="clearfix">
                                      <textarea class="col-sm-12" name="text_descripcion" id="text_descripcion" rows="4"  placeholder="Ingrese campo" ><?=  $especialidad->descripcion_espe ?></textarea>
                                  </div>
                              </div>
                          </div>
