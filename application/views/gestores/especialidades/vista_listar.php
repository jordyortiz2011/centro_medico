...
<?php
    //ruta por defecto es public/
     $data = array (
                    'titulo_header' => 'Listar especialidades',
                    'css'           => array (
                    						   //Select2
...
<?php  $data = array (  
                        'navegacion'    => array ('Gestores'  => '' , 'Especialidades' => '' , 'Listar' => '#' ),
                 ...
                 <div class="card">
                    <div class="card-header d-flex align-items-center" style="height: 4em;">
                     <h3 class="h4"><i class="fa fa-list" aria-hidden="true"></i> Listado</h3>
                        <div class="card-close ">
                            <a type="button" class="btn btn-info" href="<?= base_url('gestores/especialidades/registrar/form_registrar') ?>">
                    ...
                    <div class="card-body">
                    	<div class="table-responsive">
                    		 <table id="listado_especialidades" class="display nowrap table table-striped table-bordered">
 ...
 $data = array (
                'javascripts' => array (
                						 //Select2 (colegio)
	                                      ...
	                                      'recursos/gestores/especialidades/js/listar_eliminar_especialidades.js' ,
                                       )
                );  
