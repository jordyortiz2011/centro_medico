...
class Auth_Controller extends CI_Controller {
	...
	protected function require_min_level( $level )
	{
		...
		//echo "check"; print_r($this->auth_data); exit;
	...
	protected function _set_user_variables()
	{
        ...
        $this->auth_especialidad    = $this->auth_data->id_especialidad_user;
		...
		$data = [
            ...
            'auth_especialidad' =>  $this->auth_especialidad
		];
