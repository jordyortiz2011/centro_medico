...
class Model_listar_recibos extends CI_Model {
...
// --------------------------------------------------------------
     ...
     *  */  
	function allpagos($limit,$start,$col,$dir)
    {   
       $query = $this
                ->db
                 ->select('*')
...
// --------------------------------------------------------------
     ...
     *  */  
	 ...
	 function pagos_search($search, $search_ciclo,     $limit,$start,$col,$dir )
    {
        $query = $this
                ->db
 ...
 *  */     
    ...
    public function eliminar_pago_fisico($id_registro)
    {
    	
       $query =	$this->db->where('id_pago', $id_registro)
				  		 ->delete('tbl_pagos');
