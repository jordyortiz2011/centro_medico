...
// --------------------------------------------------------------
    ...
    public function obtener_codigo($id_registro)
    {
        $query = $this
            ->db
            ->from('tbl_codigos_prestacionales')
            ->where('id_codigo_prestacion =', $id_registro);
    ...
    public function editar_codigo($id_registro, $post)
    {
        ...
        $data = array(
            'codigo_codpre'         => $post['text_codigo'],
            'descripcion_codpre'    => $post['text_descripcion'],

        );


        $query = $this->db->where('id_codigo_prestacion', $id_registro)
                          ->update('tbl_codigos_prestacionales', $data);
