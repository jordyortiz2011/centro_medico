...
// --------------------------------------------------------------
     ...
     *  */
    function allunidades_count()
    {
        $query = $this
            ->db
            ->select('count(id_unidad) as total')
            ->from('tbl_unidades');
...
// --------------------------------------------------------------
     ...
     *  */
    function allunidades($limit, $start, $col, $dir)
    {
        $query = $this
            ->db
            ->select('*')
...
// --------------------------------------------------------------
    ...
    function unidades_search_count($search)
    {
        $query = $this
            ->db
            ->select('count(id_unidad) as total')
    ...
    public function eliminar_unidad_fisico($id_registro)
    {
