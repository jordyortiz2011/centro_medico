...
// --------------------------------------------------------------
     ...
     *  */
    function allconsultorios_count()
    {
        $query = $this
            ->db
            ->select('count(id_consultorio) as total')
...
// --------------------------------------------------------------
     ...
     *  */
    function allconsultorios($limit, $start, $col, $dir)
    {
        $query = $this
            ->db
            ->select('*')
...
// --------------------------------------------------------------
    ...
    function consultorios_search_count($search)
    {
        $query = $this
            ->db
            ->select('count(id_consultorio) as total')
    ...
    public function eliminar_codigo_fisico($id_registro)
    {
